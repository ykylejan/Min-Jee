...
const OwnerAuthRedirect = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    const publicPaths = ["/login", "/signup", "/forgot-password", "/", "/shop", "/shop/halfsized-food-warmer", "/shop/balloon-arrangement", "/shop/christmas-party", "/about-us", "/checkout"]; // Add any other public paths here
