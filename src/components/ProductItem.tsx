            ...
            <div className="w-72 lg:w-64 hover:cursor-pointer relative overflow-hidden rounded-md">
                <div className="relative">
                    <img
                        src={image}
                        alt="product_image"
                        className={`aspect-square rounded-md mb-3 transition-transform duration-300 hover:scale-105 ${className}`}
                    />
                ...
                <h1 className="text-base font-afacad text-black/70">PHP {price}</h1>
            </div>
        </Link>
    );
};
