                ...
                <section>
                    {/* <div className="grid grid-cols-3 grid-rows-2 gap-4">
                        <div className="row-span-2">
                            <div className="bg-yellow-600 w-full h-full p-3"></div>
                            </div>
                            <div className="row-span-2">
                            <div className="bg-[#334628] w-full h-full"></div>
                            </div>
                            <div className="row-span-2">
                            <div className="bg-[#778768] w-full h-full"></div>
                    ...
                    <div className="grid grid-cols-4 grid-rows-2 gap-4">
                        ...
                        <div className="col-start-1 row-start-2">
                            <div className="bg-[#778768] w-full h-full p-3"></div>
                        </div>
