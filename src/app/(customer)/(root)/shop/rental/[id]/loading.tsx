      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-x-12 justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-1/2 px-0 sm:px-4 lg:px-10">
          ...
          <div className="mt-8 sm:mt-12 lg:mt-16">
            <Skeleton className="h-5 w-16 mb-2 bg-camouflage-100" />
            <Skeleton className="h-12 w-full rounded bg-camouflage-100" />
            <Skeleton className="h-4 w-24 mt-1 bg-camouflage-100" />
          </div>
