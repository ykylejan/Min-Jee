      ...
      <Card className="border-gray-200 shadow-sm max-w-5xl mx-auto">
        <CardHeader className="border-b border-gray-100 p-4 sm:p-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-afacad_medium text-2xl sm:text-3xl">Add Products to Order</h1>
          </div>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            <div className="lg:col-span-2">
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                >
                  <SelectTrigger className="w-full sm:w-40 bg-gray-50 h-11">
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                    {selectedProducts.length === 0 ? (
                      <p className="text-gray-500 text-center py-4 bg-gray-50 rounded-lg">No products selected</p>
                    ) : (
                        ...
                        <div key={product.id} className="flex justify-between items-center border-b border-gray-100 pb-3">
                          ...
                          <div className="flex items-center gap-3">
                            <div className="flex items-center">
                              ...
                              <Input 
                                className="w-12 h-7 text-center mx-1 bg-gray-50" 
                  ...
                  <div className="mt-4 flex flex-col gap-3">
                    <Link href="/orders/order-item">
                      <Button className="bg-camouflage-400 hover:bg-camouflage-400/80 font-afacad w-full h-11"
                        disabled={selectedProducts.length === 0}>
                        Add to Order
                      </Button>
                    </Link>
                    <Link href="/orders/order-item">
                      <Button variant="outline" className="border-camouflage-400 text-camouflage-400 hover:bg-camouflage-50 font-afacad w-full h-11">
                        Cancel
                      </Button>
                    </Link>
                  </div>
